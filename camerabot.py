...
Button(control_window, text="Right", command=move_right).place(bordermode=INSIDE, relwidth=0.125, relheight=0.75, relx=0.875, rely=0.125)
Button(control_window, text="Up", command=move_up).place(bordermode=INSIDE, relwidth=0.75, relheight=0.125, relx=0.125, rely=0)
Button(control_window, text="Down", command=move_down).place(bordermode=INSIDE, relwidth=0.75, relheight=0.125, relx=0.125, rely=0.875)
